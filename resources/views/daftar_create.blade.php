    ...
    <div class="card-body">
        <form action="/daftar" method="POST">
            ...
            <div class="form-group mt-3">
                ...
                <input type="date" name="tanggal_daftar" class="form-
control" value="{{ old('tanggal_daftar') ?? date('Y-m-d') }}">
                <span class="text-danger">{{ $errors->first('tanggal_daftar')
            ...
            <div class="form-group mt-3">
                ...
                <span class="text-danger">{{ $errors->first('poli_id')
...
old('keluhan') }}</textarea>
                ...
                <span class="text-danger">{{ $errors->first('keluhan')
