                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> :
                                    ...
                                    <span style="color: white;background-color: green; padding: 3px 8px; border-radius: 5px; display:
inline-block;">
                    ...
                    <form action="/daftar/{{ $daftar->id }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="diagnosis" class="form-control" rows="4">{{ $daftar->diagnosis }}</textarea>
